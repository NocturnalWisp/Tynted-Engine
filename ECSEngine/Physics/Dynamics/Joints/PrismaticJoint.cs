...
{
	using Box2DNetMath = Box2DNet.Common.Math;
	...
	public class PrismaticJoint : Joint
	{
		...
		internal override bool SolvePositionConstraints(float baumgarte)
		{
			...
			Vector2 r1 = Box2DNet.Common.Math.Mul(R1, _localAnchor1 - _localCenter1);
			Vector2 r2 = Box2DNet.Common.Math.Mul(R2, _localAnchor2 - _localCenter2);
			...
			linearError = Box2DNet.Common.Math.Max(linearError, Box2DNet.Common.Math.Abs(C1.X));
			angularError = Box2DNet.Common.Math.Abs(C1.Y);
